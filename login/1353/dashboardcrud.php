...
<div id="shell">
	...
	<div id="content">
             ...
             <?php
                $con=mysqli_connect("mysql17.unoeuro.com", "bareaender_dk0", "1Nygummiand", "bareaender_dk0_db2");
                // Check connection
...
<div>
	...
	<div> <a href="http://film.xn--barender-m0a.dk/"  title="Bare�nder video">Tilbage til Bare&AElig;nder Video</a>
	  </div>
      </div>
    <?php endif ?>
  </body>
